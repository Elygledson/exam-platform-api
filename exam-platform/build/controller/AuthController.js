...
var AuthController = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        token = jwt.sign({ userId: user.id, email: user.email }, config_1.default.jwtSecret, { expiresIn: "30d" });
    ...
    AuthController.changePassword = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var id, _a, oldPassword, newPassword, userRepository, user, error_2, errors;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 5:
                        ...
                        return [2 /*return*/, res.send({ success: true, message: "Senha alterada com sucesso" })];
                }
            });
        });
    };
